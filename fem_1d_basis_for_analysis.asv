...
Z0 = rho0 * c0; % Specific impedance of air
...
% or (for experts):
Z = Z0*100; % acoustical impedance at wall, scattering object, piston casing (expresses: sound pressure divided by particle velocity at boundary, value range: ]0,inf[ + i*]0,inf[ )
